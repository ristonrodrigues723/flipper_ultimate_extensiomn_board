...
into a sinlge module while exending wifi ranfe of flipper to beyond 100m, this is really cheprr compared to the commercially available boards built 1/3 of the cost for the full 
board often the available boards do 1 or 2 things like there are diff modules the nrf module does the nrf task . wifi module does wifi gps gps and cc101 radio
and this should combine it all into a single board
...
![image](https://github.com/user-attachments/assets/68ab8e0f-2523-4536-9d52-09d4b3ca5031) the case WIll need changes depending on part availibility
...
pcb with components
![image](https://github.com/user-attachments/assets/96fa1324-fe17-437b-bd46-04de33202e9a)


budget is 53$ compeletely , same board from rabbit labs costs 200$ so its good
